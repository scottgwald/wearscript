...
URL = 'https://github.com/wearscript/wearscript-android/releases/download/v0.2.0/'
...
class InstallerLinux(object):
    ...
    def __init__(self):
        self.apks = [URL + 'CaptureActivity.apk', URL + 'OpenCV_2.4.6_Manager_2.9_armv7a-neon.apk', URL + 'WearScript-debug-unaligned.apk', URL + 'picarus.apk']

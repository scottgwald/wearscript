...
import com.dappervision.wearscript_tagalong.events.PicarusRegistrationSampleEvent;
import com.dappervision.wearscript_tagalong.events.WarpHEvent;
        ...
        if (mode == Mode.SAMPLEWARPPLANE || mode == Mode.SAMPLEWARPGLASS) {
            synchronized (this) {
                ...
                if (captureSample) {
                    ...
                    com.dappervision.wearscript_tagalong.Utils.eventBusPost(new PicarusRegistrationSampleEvent(framePPM));
                }
            }
        }

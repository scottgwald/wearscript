...
public class WearScriptInfo {
    ...
    public WearScriptInfo(Context context, String title, String filePath) {
        this.title = title;
    ...
    public static WearScriptInfo playground(Context context) {
    ...
    public static WearScriptInfo gistSync(Context context) {
        ...
        WearScriptInfo wsi = new WearScriptInfo(context, "Gist Sync", path);
        return wsi;
    }

    public static WearScriptInfo stop(Context context) {
    ...
    public static WearScriptInfo setup(Context context) {
